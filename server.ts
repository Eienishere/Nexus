...
// ─── Server modules ──────────────────────────────────────────────────────────
import {
  dbFileExists, openDatabase, initTables, setSessionKey, setSessionToken,
...
async function startServer() {
  ...
  app.listen(3000, "127.0.0.1", () => {
    console.log("╔═══════════════════════════════════════════════════════════╗");
    console.log("║  NEXUS Server running on http://127.0.0.1:3000           ║");
    ...
    console.log("║  Network:    Localhost only (Dış ağlara kapalı)         ║");
    console.log("╚═══════════════════════════════════════════════════════════╝");
  });
}
